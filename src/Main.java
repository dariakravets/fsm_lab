...
public class Main {
    ...
    private static void getAllWords(ArrayList<String> result, ArrayList<Character> alphabet, String base, int length) {
        String current;
    ...
    public static void main(String[] args) throws IOException {
        //read file
        BufferedReader reader = new BufferedReader(new FileReader("E://IdeaProjects//fsm_lab//src//fsm_def.txt"));
